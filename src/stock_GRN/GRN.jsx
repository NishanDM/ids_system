        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            <button
                ...
                className={`px-3 py-1 border rounded cursor-pointer text-xs hover:bg-gray-50 ${
            ...
            <button
              ...
              className={`px-3 py-1 rounded text-xs cursor-pointer ${stockUpdated ? "bg-green-600 text-white hover:bg-green-700" : "bg-gray-200 text-gray-500 cursor-not-allowed"}`}
